...
//     setActiveJobs((prev) => prev.filter((j) => j.id !== jobToClose.id));
...
//                       Archiving protocol and notifying team...
//                     </p>
//                   </motion.div>
//                 )}
//               </AnimatePresence>
...
//                         : "border-[var(--border-subtle)] bg-[var(--input-bg)] text-[var(--text-main)] hover:border-primary/40"
//                     }`}
//                   >
//                     {reason}
//                   </button>
...
//                   className="flex-[2] py-3 rounded-xl bg-red-500 text-white font-bold text-sm shadow-lg shadow-red-500/20 disabled:opacity-30 transition-all"
//                 >
//                   Confirm Close
//                 </button>
//               </div>
...
// function JobCard({ job, onClose }: { job: any; onClose: () => void }) {
//   const router = useRouter();
...
//               </span>
//               {job.cat.charAt(0).toUpperCase() + job.cat.slice(1)}
//             </span>
//             {job.tag && (
//               <span
...
//                     className="absolute right-0 mt-2 w-52 bg-[var(--surface)] rounded-2xl border border-[var(--glass-border)] shadow-xl overflow-hidden p-1.5 z-[100]"
//                   >

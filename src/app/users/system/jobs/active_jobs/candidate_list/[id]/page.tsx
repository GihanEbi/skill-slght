...
//       {/* --- AI INTERVIEW POPUP (EXACT HTML LAYOUT) --- */}
//   <AnimatePresence>
//     {showAiInterview && (
...
//               Review AI Interview
//             </button>
//             <button className="px-6 py-3 bg-primary text-[var(--background)] font-bold rounded-xl text-sm hover:shadow-glow-strong transition-all flex items-center gap-2 active:scale-95">

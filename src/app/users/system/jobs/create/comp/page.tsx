            ...
            >
              ...
              <form className="space-y-10">
                ...
                <div>
                  ...
                  <div className="space-y-6 md:space-y-8 p-4 md:p-6 bg-[var(--input-bg)] border border-[var(--border-subtle)] rounded-2xl">
                    <div className="flex flex-col md:flex-row items-center gap-4">
                      <div className="w-full md:flex-1">
                        <label className="block text-[10px] text-[var(--text-muted)] mb-1 font-black uppercase tracking-wider">
                          Currency
                        ...
                        <div className="relative">
                          <select className="premium-input rounded-xl py-3 px-4 font-bold text-[var(--text-main)] text-sm appearance-none cursor-pointer">
                            <option value="USD">USD - US Dollar</option>
                            <option value="EUR">EUR - Euro</option>
                          </select>
                      ...
                      <div className="w-full md:flex-[2]">
                        ...
                        <div className="relative">
                          <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[var(--text-muted)] text-sm font-bold">
                            $
                          </span>
                          <input
                            className="premium-input rounded-xl py-3 pl-7 pr-4 text-[var(--text-main)] text-sm font-bold"
                            type="number"
                            value={minSalary}
                            onChange={(e) =>
                              setMinSalary(Number(e.target.value))
                    ...
                    <div className="px-2 pb-2">
                      <div className="relative h-1.5 md:h-2 bg-primary/10 rounded-full w-full">
                        <div className="absolute inset-0 bg-primary/40 rounded-full left-[25%] right-[35%]"></div>
                        <div className="absolute w-4 h-4 md:w-5 md:h-5 bg-white border-2 border-primary rounded-full -top-1.5 left-[25%] cursor-pointer shadow-lg hover:scale-110 transition-transform"></div>
                        <div className="absolute w-4 h-4 md:w-5 md:h-5 bg-white border-2 border-primary rounded-full -top-1.5 right-[35%] cursor-pointer shadow-lg hover:scale-110 transition-transform"></div>
                      </div>
                      <div className="flex justify-between mt-4 text-[9px] md:text-[10px] text-[var(--text-muted)] font-black uppercase tracking-widest">
                        <span>$50k</span>
                        <span>$150k</span>
                        <span>$250k+</span>
                      </div>
            ...
            >
              ...
              <div className="relative z-10 space-y-6 md:space-y-8">
                ...
                <div className="space-y-4 pt-4 border-t border-[var(--border-subtle)]">
                  ...
                  <div className="p-4 bg-primary/5 rounded-2xl border border-primary/10">
                    <p className="text-[11px] text-[var(--text-muted)] italic leading-relaxed text-center">
                      "Your range is highly competitive. Increasing equity by
                      0.1% puts this in the 95th percentile."
                    </p>
                  </div>
                </div>
              </div>
  ...
  return (
    <div className="p-3 bg-[var(--input-bg)] rounded-xl border border-primary/10">
      ...
      <div className="flex justify-between items-center text-[10px]">
        <p className="text-[var(--text-muted)] font-bold uppercase">
          Avg. Base
        </p>
        <p className="font-black text-accent">{range}</p>
      </div>
    </div>
  );
}
